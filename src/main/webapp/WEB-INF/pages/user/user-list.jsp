				...
				<c:if test="${!empty userList}">
					<c:forEach items="${userList}" var="user" varStatus="status">
						<tr>
							...
							<td><a class="btn btn-primary btn-sm" href="javascript:goupdate(${user.rowId});">锁定</a> 
							<!-- data-xxx H5以后允许自定义元素的属性 --> 
							<a class="btn btn-primary btn-sm" href="javascript:;" data-rowId="${user.rowId}" id="deleteA">解封</a></td>
						</tr>
					</c:forEach>
				</c:if>
			</tbody>
...
<%-- 引入分页 --%>
<%@ include file="/manage_bottom.jsp" %>